...
Дополнительно протестированы (Секция 12): X-Learner, DR-Learner, R-Learner (`causalml` 0.16.0) и CausalForestDML (`econml` 0.16.0). Все значительно уступают CT baseline по Qini AUC (−87–94%).
...
## 13. Интерпретация метрик и оценка качества результатов
