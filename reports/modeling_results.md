...
| DR-Learner | 0.2122 | 0.0984 | 0.2408 | 0.1322 | 0.0063 |
| CausalForestDML *(80K sub)* | 0.1817 | 0.0876 | 0.2087 | 0.1145 | 0.0065 |
| URF (original) | 0.0730 | 0.0375 | 0.0826 | 0.0459 | 0.0011 |
| URF (SMOTE 200K) *(200K sub)* | 0.1292 | 0.0654 | 0.1926 | 0.1005 | 0.0058 |
...
| DR-Learner | 0.2408 | 0.0046 | 52.3× | ❌ Критическое |
| CausalForestDML *(80K sub)* | 0.2087 | 0.0048 | 43.5× | ❌ Критическое |
| URF (original) | 0.0826 | 0.0078 | 10.5× | ⚠️ Сильное |
| URF (SMOTE 200K) *(200K sub)* | 0.1926 | 0.0182 | 10.6× | ⚠️ Сильное |

**Ключевые выводы:**

1. **DR-Learner (52.3×), T-Learner (41.3×), X-Learner (∞), CausalForestDML (43.5×)** — критическое переобучение. R-Learner (25.4×) и T-Learner+SMOTE (21.4×) — очень сильное. Все meta-learner MSE-методы запоминают train-распределение, плохо обобщаются.
...
6. **Примечание по подвыборкам:** CausalForestDML обучался на 80K из 480K (train метрики на тех же 80K), URF SMOTE — на 200K из 722K. Ratio для этих моделей завышен, т.к. их train-выборка меньше полного трейна.
