...
| Модель | Qini AUC | ASD | Что это значит |
|--------|----------|-----|----------------|
| CT + LightGBM | **0.0752** | 0.186 | Отличное ранжирование, некалиброванная шкала |
| DR/R-Learner | 0.010 | **0.0005** | Хорошая калибровка, плохое ранжирование |
